...
export function PopularCategories() {
    const [all_product, setAllproduct] = useState(false);
...
const [data , setData] = useState([])
    ...
    //  get data from api and  update quantity of perticular id in react js 
    console.log("all_product", all_product.data)
